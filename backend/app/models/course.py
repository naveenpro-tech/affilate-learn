...
class Course(Base):
    ...
    individual_price = Column(Float, nullable=True, default=199.0)  # Price for individual purchase
    available_for_individual_purchase = Column(Boolean, default=True)  # Can be purchased individually
